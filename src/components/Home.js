  ...
  return(
    <section className="home-content">
     <div className="home-side-content">
      <h2>Bonjour,</h2>
      <p>Je m'appelle Julien, développeur web fullstack en JavaScript, NodeJs, React et toujours prêt à découvrir de nouvelles technos.</p>
      ...
      Actuellement à la recherche d'une entreprise pour une alternance à la <a href = "https://www.wildcodeschool.com/fr-FR/alternance" target="_blank">WildCodeSchool</a> dans le but d'améliorer mes compétences et préparer un titre professionnel Concepteur Développeur d'Applications.</p>
